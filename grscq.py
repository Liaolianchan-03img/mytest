...
with col1:
    ...
    # 基本信息
    st.subheader("基本信息")
    name = st.text_input("姓名", "廖廖")
    position = st.text_input("职位", "自由职业者")
    phone = st.text_input("电话", "17677169536")
    email = st.text_input("邮箱", "237917611@qq.com")
    birth_date = st.text_input("出生日期", "2025/06/07")
    ...
    with col1_2:
        ...
        expected_salary = st.text_input("期望薪资", "19123-25390元")
    ...
    # 最佳联系时间
    best_time = st.text_input("最佳联系时间", "9：00")
    
    # 个人简介
    st.subheader("个人简介")
    introduction = st.text_area(
        "个人简介",
        "廖廖，本科为信息安全专业，主要研究内容为机器学习与信息安全，现为广西职业师范学院的学生。",
        height=150
    )
    
    # 座右铭
    motto = st.text_input("座右铭", "你是最优解")
